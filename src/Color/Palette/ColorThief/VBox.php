...
namespace Carica\CanvasGraphics\Color\Palette\ColorThief {
  ...
  class VBox {
    ...
    public function __construct($r1, $r2, $g1, $g2, $b1, $b2, $histogram) {
      $this->r1 = $r1;
      $this->r2 = $r2;
      $this->g1 = $g1;
      $this->g2 = $g2;
          ...
          for ($i = $this->r1; $i <= $this->r2; $i++) {
            for ($j = $this->g1; $j <= $this->g2; $j++) {
              for ($k = $this->b1; $k <= $this->b2; $k++) {
                ...
                if (isset($this->histogram[$index])) {
                  $npix += $this->histogram[$index];
                }
              }
            }
          }
    ...
    public function contains(array $pixel, $rshift = ColorThief::RSHIFT): bool {
      $rval = $pixel[0] >> $rshift;
      $gval = $pixel[1] >> $rshift;
      $bval = $pixel[2] >> $rshift;
    ...
    public function longestAxis(): string {
      ...
      return array_search(max($colorWidth), $colorWidth, TRUE);
    }
  }
}
